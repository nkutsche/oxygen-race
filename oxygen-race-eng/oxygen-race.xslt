...
<!--
	STEP 2:
	Go at the end of this documents!
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:es="http://www.escali.schematron-quickfix.com/" xmlns:axsl="http://www.w3.org/1999/XSL/TransformAlias" xmlns:bxsl="http://www.w3.org/1999/XSL/TransformAliasAlias" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xsm="http://www.schematron-quickfix.com/manipulator/process" exclude-result-prefixes="xs xd" version="2.0" xml:id="start">
...
-->
    ...
    <xsl:function name="sqf:function">
        <xsl:param name="blub"/>
        <!--	
		STEP 11:
		Where was this key defined?
		-->
        <xsl:sequence select="key('key', 'hallo', root($blub))"/>
    </xsl:function>
    ...
    <xsl:key name="key" match="Element" use="key-wert"/>
    
    <!--	
	STEP 12:
	Where was this key used?
	-->
    <xsl:key name="param" match="xsl:param" use="@id"/>
...
-->
    ...
    <xsl:include href="oxygen-race-include.xslt"/>
...
-->
    ...
    <xsl:template name="setVarContext" match="sqf:fix" mode="copy">
        ...
        <!--
	STEP 6:
	Go at the beginning of this template
	-->
    </xsl:template>
    ...
    <xsl:template match="sqf:add">
        ...
        <axsl:for-each-group select="{$sqf:match}" group-by="es:base-uri(.)">
            <axsl:for-each select="$sqf:ruleContext">
                ...
                <!--					    
    			    STEP 9:
    			    Go at the beginning of the surrounding template
    			    -->
                ...
                <xsl:if test="
                    ...
                    <axsl:if test="$sqf:match != ''">
                        <bxsl:template>
                            ...
                            <!--	
			STEP 4:
			Where was this parameter declared?
			-->
...
-->
    ...
    <!--
STEP 3:
Where was this parameter was used?
-->
